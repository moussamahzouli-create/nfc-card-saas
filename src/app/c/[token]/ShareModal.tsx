        ...
        >
          ...
          >
            ...
            <div className="flex items-center gap-2 p-1.5 bg-slate-100 dark:bg-slate-800 rounded-xl border border-slate-200 dark:border-slate-700">
              <span className="flex-1 text-[11px] font-mono text-slate-600 dark:text-slate-300 px-2 truncate">
                {cardUrl}
              </span>
              <button
                type="button"
                onClick={handleCopy}
                className="px-3 py-1.5 rounded-lg font-bold text-xs flex items-center gap-1.5 text-white transition-all shadow-sm active:scale-95 cursor-pointer"
                style={{ background: primaryColor }}
              >
