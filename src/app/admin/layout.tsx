...
import { LayoutDashboard, CreditCard, Import, Layers, ShieldAlert, Cpu, ArrowLeft, LogOut, Loader2, Globe, Package, ShoppingBag, Mail, Users, Contact, Smartphone } from 'lucide-react';
...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  const menuItems = [
    ...
    { href: '/admin/nfc-tool', label: 'تطبيق برمجة NFC للهاتف 📲', icon: Smartphone },
