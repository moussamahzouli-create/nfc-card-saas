...
import { Mail, Lock, Languages, ArrowLeft, ArrowRight, Eye, EyeOff } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-tr from-blue-600 to-indigo-700 items-center justify-center p-12 text-white relative">
        ...
        <div className="max-w-md space-y-6 relative z-10">
          ...
          <p className="text-blue-100 text-base leading-relaxed">
            Create professional contact profiles, customize colors and themes in real-time, and link physical NFC cards in seconds.
          </p>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="space-y-1.5">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 focus:bg-white dark:bg-slate-950 focus:dark:bg-slate-900 border border-slate-200 focus:border-blue-600 dark:border-slate-800 focus:dark:border-blue-500 rounded-xl outline-none font-medium text-sm transition-all"
                />
              </div>
            </div>
            ...
            <div className="space-y-1.5">
              <div className="flex justify-between items-center">
                ...
                <Link href="/auth/forgot-password" className="text-xs font-bold text-blue-600 dark:text-blue-400 hover:underline">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-10 pr-10 py-3 bg-slate-50 focus:bg-white dark:bg-slate-950 focus:dark:bg-slate-900 border border-slate-200 focus:border-blue-600 dark:border-slate-800 focus:dark:border-blue-500 rounded-xl outline-none font-medium text-sm transition-all"
                />
                <button
                  type="button"
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-3.5 px-4 font-bold text-white rounded-xl bg-gradient-to-r from-blue-600 to-indigo-600 shadow-md shadow-blue-500/10 hover:shadow-blue-500/25 active:scale-[0.98] transition-all disabled:opacity-50 disabled:pointer-events-none flex items-center justify-center text-sm cursor-pointer"
            >
